...
## Current phase
**F1 / M1.6-abort-timeout mergeado en `developer`** (3c9d652).

## Next actions (roadmap)
1. **M1.7-gitignore** — issue #57: inline comments rompen patrones (.angular/, .playwright-mcp/, www/, node_modules/.cache/) (siguiente).
2. **M1.8-font-montserrat** — issue #56: bundlear Montserrat-Regular+Bold o cambiar brand a system-ui (decisión de producto).
3. **M1.9-forgot-reset** — backlog original Forgot/reset password + deep links.
4. **M1.10-splash-tabs** — Splash animado + tabs base.
5. **F2.x** — Home + catálogo + producto.
6. **F3.x** — Cart + checkout + pagos.
...
[RELEVO DE AGENTE]
- Fase actual: F1 / M1.6-abort-timeout mergeado en `developer` (3c9d652). Issues #51, #52, #53, #54, #55 cerradas. Tests: 232 verdes (+18 vs 214). Siguiente: M1.7-gitignore (#57).
